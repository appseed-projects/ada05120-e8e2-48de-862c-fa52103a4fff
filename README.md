...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-24 16:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ada05120-e8e2-48de-862c-fa52103a4fff.git
$ cd ada05120-e8e2-48de-862c-fa52103a4fff
```
